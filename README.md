...
`seed/articles.seed.json` (20 adet uzun-form Türkçe makale) dosyasından makale/kategori upsert:
...
## Seed kaynakları
- Makaleler: `seed/articles.seed.json` (20 adet uzun-form Türkçe makale)
